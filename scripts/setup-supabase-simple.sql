-- Yoke Dating App - Database Schema (Simplified - No PostGIS)
-- Copy this entire file and run it in Supabase SQL Editor
-- This version doesn't require PostGIS extension
...
CREATE TABLE IF NOT EXISTS public.profiles (
  ...
  bio TEXT,
  photo_url TEXT,
  -- Location stored as latitude/longitude (no PostGIS needed)

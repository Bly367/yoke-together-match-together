...
-- Run this in Supabase SQL Editor if migration 002 hasn't been applied
...
-- Create match_reads table if it doesn't exist
...
-- RLS Policies for message_reads (drop if exists first for idempotency)
DROP POLICY IF EXISTS "Users can view read receipts for their matches" ON public.message_reads;
